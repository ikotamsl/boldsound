...
APP_BUNDLE="$PRODUCT_DIR/BoldSound-Dev.app"
LOG_FILE="${TMPDIR:-/tmp}/boldsound-dev.log"
BUILD_LOG_FILE="${TMPDIR:-/tmp}/boldsound-dev-build.log"
...
<dict>
    ...
    <string>com.boldsound.prototype</string>
    <key>CFBundleName</key>
    <string>BoldSound</string>
    ...
    <string>BoldSound needs microphone access for voice dictation and meeting speaker detection.</string>
...
echo "[3/5] Stopping existing BoldSound processes…"
...
pkill -f "BoldSound-Dev.app/Contents/MacOS/MacParakeet" || true
...
sleep 2
PID="$(pgrep -f "BoldSound-Dev.app/Contents/MacOS/MacParakeet" | head -n 1 || true)"
