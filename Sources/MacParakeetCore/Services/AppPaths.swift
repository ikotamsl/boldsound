...
public enum AppPaths {
    public static let preferencesSuiteName = "com.boldsound.prototype"
    ...
    static func resolvedAppSupportDir(environment: [String: String]) -> String {
        ...
        return path + "/BoldSound"
    }

    /// Database file path
    public static var databasePath: String {
        "\(appSupportDir)/boldsound.db"
    }
    ...
    public static var tempDir: String {
        "\(NSTemporaryDirectory())boldsound"
    }
